    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
        ...
        <div className='flex flex-col lg:flex-row gap-4'>
            ...
            <div className='bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4'>
                 <div className='w-1/3'>
                 <Image src="https://images.pexels.com/photos/1036623/pexels-photo-1036623.jpeg?auto=compress&cs=tinysrgb&w=1200" alt='' width={144} height={144} className='w-36 h-36 rounded-full object-cover' />
                 </div>
